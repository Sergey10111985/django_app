...
urlpatterns = [
    ...
    path('products/<int:pk>/orders/', UserOrderListView.as_view(), name='user_orders'),
    ...
    path('orders/users/<int:pk>/export', UserOrdersExportView.as_view(), name='user_orders_export'),
